...
public class MemberController {
	...
	public String login(String id, String password) {
		 ...
		 * 
		 * */
		if(map.containsKey(id)) { //전달 받은 id가 존재하는지 확인 후
...
//		if(map.containsKey(id)) {
//			map.get(id).getName().equals(newName);
//		}
	...
	public boolean equals(Object obj) {
		...
		return Objects.equals(m, other.m) && Objects.equals(map, other.map);
	}
}
