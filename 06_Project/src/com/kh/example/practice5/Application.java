...
//		app.employeeMenu();
		...
		public void updateEmp() {
			...
			System.out.print("사원의 어느정보를 수정하시겠습니까? ");
			...
			case 3 :
				...
				double bounus = Double.parseDouble(sc.nextLine());
				employeeController.modify(bounus);
				break;
