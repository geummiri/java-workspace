...
public class Application {
	 ...
	 * -접근 제한자는 public , (default)
	 * -클래스는 필드(Field), 메소드(Method), 생성자(Constructor)가 정의
	 * -클래스 작성 시 객체지향언어의 특징 중 추상화(Abstraction), 캡슐화(Encapsulation)가 적용되어야 함
	 * 
	 * 객체 생성
	 * [표현법]
	 * 클래스명 변수명 = new 클래스명();
...
/*
	...
	class Tv {
		...
		void power() { //TV를 켜거나 끄는 기능_void는 반환값이 없을 때 사용하는 것
			power =! power;
			} 
		...
		//String.length or String.length() -> 메소드에서 가져올때는 () 필요함
}
*/
