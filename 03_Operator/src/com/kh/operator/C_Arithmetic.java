...
//			c.method1();
		...
		public void method1() {
			...
			System.out.println("num1 / num2 = " + (num1 / num2)); //3 -> 나누기 했을 때의 몫
			System.out.println("num1 % num2 = " + (num1 % num2)); //1 -> 나누기 했을 때의 나머지
		}
		...
		public void method2() {
			...
			int h = 2;
			int i = (a++) + b / (--c / f) *(g-- - d) % (++e + h); //a=6(7), b=9, c=15, d=1, e=6, f=4, g=11 /6+9 / (15/4) * (11-1) % 6+2 = 6+9/3*10%8 = 12
