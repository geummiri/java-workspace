...
//		b.method1();
	...
	public void method1() {
		...
		System.out.println("2회 수행 후 값 : " + ++number); //12 number = number + 1
		...
		System.out.println("gn위 연산자 적용 후 : " + number); //14
	}
	...
	public void method2() {
		...
		System.out.println((number1++) + (--number2) + (--number3)); //number1 = 12, number2 = 20, number3 = 29 61
