...
/*
 * Operator
 * - Operator 함수적 인터페이스느 매개값과 리턴 값이 있는
 * 	 applyXXX() 추상 메서드를 가지고 있음
 * - applyXXX() 추상 메서드는 주로 매개값을 이용해서 연산하고 동일한 타입으로 결과 리턴하는 역할
 */
...
//		d.method2();
	...
	//IntUnaryOperator : 한개의 int 연산
	public void method2() {
		IntUnaryOperator ino = a -> a *a;
		System.out.println(ino.applyAsInt(2));
	}
