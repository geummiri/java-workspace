...
import com.kh._abstract.step2.PotatoPizza;
	 ...
	 * -미완성 클래스이기 떄문에 new 연산자를 통해서 객체를 생성할 수 없음 
	 * -일반적인 멤버(필드, 메서드)도 포함이 가능(필드 + 메서드 + 추상 메서드)
	 * -추상 클래스로 객체를 생성할 수 없지만 참조형 변수의 타입으로 사용 가능
...
public class Application {
	...
	//	Sports sport = new Sports(); // <-- 생성 불가!
		...
		Pizza[] pizza = {new BulgogiPizza(32900, "피자헛"), new PotatoPizza(27900, "도미노피자"), new PineApplePizza(23000, "피자알볼로")};
